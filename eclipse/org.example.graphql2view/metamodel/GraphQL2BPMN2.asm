...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchType2bpmn():V"/>
		<constant value="__exec__"/>
		<constant value="Type2bpmn"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyType2bpmn(NTransientLink;):V"/>
		<constant value="__matchType2bpmn"/>
		...
		<constant value="11:4-13:5"/>
		<constant value="__applyType2bpmn"/>
